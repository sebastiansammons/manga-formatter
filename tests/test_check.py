...
class TestCheck(unittest.TestCase):
    ...
    def test_manual_single_chapter(self):
        # Bad manga title
        self.assertEqual(manga_check.check_manual_single_chapter(mc.SOURCE_PATH, mc.DESTINATION_PATH, "", 78, "Title"), False)
        # Bad manga number
        self.assertEqual(manga_check.check_manual_single_chapter(mc.SOURCE_PATH, mc.DESTINATION_PATH, "manga", "", "Title"), False)
        # Bad manga title
        self.assertEqual(manga_check.check_manual_single_chapter(mc.SOURCE_PATH, mc.DESTINATION_PATH, "manga only", 78, ""), False)
        
        # Bad source, empty
        shutil.copytree("./tests/data/test_check/manual_single_chapter/Empty src/src/", mc.SOURCE_PATH)
        self.assertEqual(manga_check.check_manual_single_chapter(mc.SOURCE_PATH, mc.DESTINATION_PATH, "Blue Box", 9,  "Empty Chapter"), False)
        shutil.rmtree(mc.SOURCE_PATH)
        # Bad source, file with no extension
        shutil.copytree("./tests/data/test_check/manual_single_chapter/No ext/src/", mc.SOURCE_PATH)
        self.assertEqual(manga_check.check_manual_single_chapter(mc.SOURCE_PATH, mc.DESTINATION_PATH, "Blue Box", 9,  "Missing .ext Chapter"), False)
        shutil.rmtree(mc.SOURCE_PATH)
        ...
        self.assertEqual(manga_check.check_manual_single_chapter(mc.SOURCE_PATH, mc.DESTINATION_PATH, "Blue Box", 9,  "Not all files Chapter"), False)
        shutil.rmtree(mc.SOURCE_PATH)

        # Bad dest, not empty
        shutil.copytree("./tests/data/test_check/manual_single_chapter/Non empty dest/dest/", mc.DESTINATION_PATH)
        self.assertEqual(manga_check.check_manual_single_chapter(mc.SOURCE_PATH, mc.DESTINATION_PATH, "Blue Box", 9,  "Non empty dest"), False)
        shutil.rmtree(mc.DESTINATION_PATH)

        #Working manual chapter
        shutil.copytree("./tests/data/test_check/manual_single_chapter/Working src/src/", mc.SOURCE_PATH)
        shutil.copytree("./tests/data/test_check/manual_single_chapter/empty dest/dest/", mc.DESTINATION_PATH)
        self.assertEqual(manga_check.check_manual_single_chapter(mc.SOURCE_PATH, mc.DESTINATION_PATH, "Attack on Titan", 139,  "Working Chapter"), True)
        shutil.rmtree(mc.SOURCE_PATH)
        shutil.rmtree(mc.DESTINATION_PATH)

    def test_manual_multiple_chapter(self):
        # Bad manga entry
        self.assertEqual(manga_check.check_manual_multiple_chapter(mc.SOURCE_PATH, mc.DESTINATION_PATH, ""), False)
        # Empty source
        ...
        self.assertEqual(manga_check.check_manual_multiple_chapter(mc.SOURCE_PATH, mc.DESTINATION_PATH, "Blue Box"), False)
        shutil.rmtree(mc.SOURCE_PATH)
        shutil.rmtree(mc.DESTINATION_PATH)
        # bad file
        ...
        shutil.copytree("./tests/data/test_check/manual_multi_chapter/empty dest/dest/", mc.DESTINATION_PATH)
        self.assertEqual(manga_check.check_manual_multiple_chapter(mc.SOURCE_PATH, mc.DESTINATION_PATH, "Blue Box"), True)
        shutil.rmtree(mc.SOURCE_PATH)
        shutil.rmtree(mc.DESTINATION_PATH)
        ...
        # Dest not empty
        shutil.copytree("./tests/data/test_check/manual_multi_chapter/Non empty dest/dest/", mc.DESTINATION_PATH)
        self.assertEqual(manga_check.check_manual_multiple_chapter(mc.SOURCE_PATH, mc.DESTINATION_PATH, "Blue Box"), False)
        shutil.rmtree(mc.DESTINATION_PATH)
        ...
        shutil.copytree("./tests/data/test_check/manual_multi_chapter/empty dest/dest/", mc.DESTINATION_PATH)
        self.assertEqual(manga_check.check_manual_multiple_chapter(mc.SOURCE_PATH, mc.DESTINATION_PATH, "Attack on Titan"), True)
        shutil.rmtree(mc.SOURCE_PATH)
        shutil.rmtree(mc.DESTINATION_PATH)
    ...
    def test_manual_volume(self):
        ...
        self.assertEqual(manga_check.check_manual_volume(mc.SOURCE_PATH, mc.DESTINATION_PATH, "One Piece", 35), False)
        shutil.rmtree(mc.SOURCE_PATH)
        shutil.rmtree(mc.DESTINATION_PATH)
