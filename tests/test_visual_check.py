...
class TestVisualCheck(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            shutil.copytree("./tests/data/manga/", "./tests/data/test_visual_check/manga/")
        except:
            pass

    def tearDown(self):
        try:
            shutil.rmtree("./tests/data/test_visual_check/db/")
    ...
    def test_auto_chapter(self):
        ...
        shutil.copytree("./tests/data/test_visual_check/auto_chapter/One Piece/src/", manga_config.SOURCE_PATH)
    ...
    def test_single_chapter(self):
        try:
            os.mkdir("./tests/data/test_visual_check/dest/")
        except:
            pass
        manga_config.DESTINATION_PATH = "./tests/data/test_visual_check/dest/single_chapter/"
    ...
    def test_multi_chapter(self):
        try:
            ...
            pass
        manga_config.DESTINATION_PATH = "./tests/data/test_visual_check/dest/multi_chapter/"
        os.mkdir(manga_config.DESTINATION_PATH)
    ...
    def test_manual_volume(self):
        try:
            ...
            pass
        manga_config.DESTINATION_PATH = "./tests/data/test_visual_check/dest/manual_volume/"
        os.mkdir(manga_config.DESTINATION_PATH)
        shutil.copytree("./tests/data/test_visual_check/manual_volume/src/", manga_config.SOURCE_PATH)
