...
class TestAutoPreview(unittest.TestCase):
    ...
    def setUp(self):
        manga_config.SOURCE_PATH = "./manga-formatter/tests/data/test_preview/src/"
        manga_config.DESTINATION_PATH = "./manga-formatter/tests/data/test_preview/dest/"
        manga_config.MANGA_PATH = "./manga-formatter/tests/data/test_preview/manga/"
        manga_config.DB_FILE_PATH = "./manga-formatter/tests/data/test_preview/db/test_manga.db"
        shutil.copytree("./manga-formatter/tests/data/db/", "./manga-formatter/tests/data/test_preview/db/")
        shutil.copytree("./manga-formatter/tests/data/manga/", "./manga-formatter/tests/data/test_preview/manga/")

    def tearDown(self):
        try:
            shutil.rmtree("./manga-formatter/tests/data/test_preview/db/")
            shutil.rmtree("./manga-formatter/tests/data/test_preview/manga/")
            shutil.rmtree(manga_config.SOURCE_PATH)
        except:
            pass

    def test_auto_chapter_preview(self):
        shutil.copytree("./manga-formatter/tests/data/test_preview/auto_chapter/Not One Piece/src/", manga_config.SOURCE_PATH)
        ...
        shutil.copytree("./manga-formatter/tests/data/test_preview/auto_chapter/One Piece/src/", manga_config.SOURCE_PATH)
    ...
    def test_auto_volume_preview(self):
        shutil.copytree("./manga-formatter/tests/data/test_preview/auto_volume/Not One Piece/src/", manga_config.SOURCE_PATH)
        ...
        shutil.copytree("./manga-formatter/tests/data/test_preview/auto_volume/One Piece/src/", manga_config.SOURCE_PATH)
