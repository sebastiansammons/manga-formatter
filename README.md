...
services:
  manga_format:
    ...
    environment:
      ...
      # DirectoryPaths
      # manga_config.py
      - MANGA_PAGE_PATH=<path to MANGA_PAGE_PATH>
      ...
      # epub_config.py
      - MANGA_EPUB_PATH=<path to MANGA_EPUB_PATH>
      - EPUB_TEMPLATE_PATH=<path to EPUB_TEMPLATE_PATH>
      
      # SubDirectoryPaths
      # Note: These are the subdirectories for the title's directory. 
      #       I recommend using the default in _config.py
      # manga_config.py
      - CHAPTER_SUBPATH = <path to CHAPTER_SUBPATH>
      - VOLUME_SUBPATH = <path to VOLUME_SUBPATH>
