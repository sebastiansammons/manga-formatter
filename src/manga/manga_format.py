...
def auto_chapter_format(manga, chapter_title):
    ...
    if(manga == "One Piece"):
        ...
        chapter_pages.copyfile(op_cover_path, op_cover_filename)
    ...
    manga_db.close()
    del manga_db
    logger.info("RENAME: NEW CHAPTER ADDED FOR " + manga)
...
def auto_volume_format(manga, last_chapter_of_new_volume, volume_title):
    ...
    manga_db.close()
    del manga_db
    logger.info("RENAME: NEW VOLUME ADDED FOR " + manga)
...
def manual_single_chapter_format(manga, chapter_number, chapter_title):
    ...
    del chapter_pages, dest_path
    logger.info("RENAME: MANUAL SINGLE CHAPTER RENAME FOR " + manga)
...
def manual_multiple_chapter_format(manga):
    ...
    logger.info("RENAME: MANUAL MULTIPLE CHAPTER RENAME FOR " + manga)
...
def manual_volume_format(manga, volume_number, volume_title):
    ...
    logger.info("RENAME: MANUAL VOLUME RENAME FOR " + manga)
